...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The TestExpNu recording.
    /// </summary>
    [TestModule("fb2e7320-63c8-4810-8a67-41f36462136b", ModuleType.Recording, 1)]
    public partial class TestExpNu : ITestModule
    {
        /// <summary>
        ...
        static TestExpNu instance = new TestExpNu();
        ...
        /// </summary>
        public static TestExpNu Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'Калькулятор.SomeContainer.ButtonXSq' at Center.", repo.Калькулятор.SomeContainer.ButtonXSqInfo, new RecordItemIndex(2));
