...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The TestSubtractionNuNf recording.
    /// </summary>
    [TestModule("001f9162-7e22-421c-9983-1e6ecc344811", ModuleType.Recording, 1)]
    public partial class TestSubtractionNuNf : ITestModule
    {
        /// <summary>
        ...
        static TestSubtractionNuNf instance = new TestSubtractionNuNf();

        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public TestSubtractionNuNf()
        {
        }
        ...
        /// </summary>
        public static TestSubtractionNuNf Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'Калькулятор.SomeContainer.Button8' at Center.", repo.Калькулятор.SomeContainer.Button8Info, new RecordItemIndex(3));
