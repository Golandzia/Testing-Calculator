...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The TestSubtractionPfPf recording.
    /// </summary>
    [TestModule("1595efdc-6243-44be-bc98-fc124d8f7ff6", ModuleType.Recording, 1)]
    public partial class TestSubtractionPfPf : ITestModule
    {
        /// <summary>
        ...
        static TestSubtractionPfPf instance = new TestSubtractionPfPf();

        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public TestSubtractionPfPf()
        {
        }
        ...
        /// </summary>
        public static TestSubtractionPfPf Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'Калькулятор.SomeContainer.Button7' at Center.", repo.Калькулятор.SomeContainer.Button7Info, new RecordItemIndex(3));
            ...
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'Калькулятор.SomeContainer.Button71' at Center.", repo.Калькулятор.SomeContainer.Button71Info, new RecordItemIndex(6));
            repo.Калькулятор.SomeContainer.Button71.Click();
            Delay.Milliseconds(0);
