...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The TestSubtractionPuPu recording.
    /// </summary>
    [TestModule("ce721a20-414d-4107-9e37-c70d4fc304e7", ModuleType.Recording, 1)]
    public partial class TestSubtractionPuPu : ITestModule
    {
        /// <summary>
        ...
        static TestSubtractionPuPu instance = new TestSubtractionPuPu();

        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public TestSubtractionPuPu()
        {
        }
        ...
        /// </summary>
        public static TestSubtractionPuPu Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'Калькулятор.SomeContainer.Button5' at Center.", repo.Калькулятор.SomeContainer.Button5Info, new RecordItemIndex(2));
