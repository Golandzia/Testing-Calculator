...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The TestDivisionPfPf recording.
    /// </summary>
    [TestModule("3d784cfa-1b94-47e5-8cd7-e52d8e7bdcc0", ModuleType.Recording, 1)]
    public partial class TestDivisionPfPf : ITestModule
    {
        /// <summary>
        ...
        static TestDivisionPfPf instance = new TestDivisionPfPf();

        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public TestDivisionPfPf()
        {
        }
        ...
        /// </summary>
        public static TestDivisionPfPf Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'Калькулятор.SomeContainer.Button10' at Center.", repo.Калькулятор.SomeContainer.Button10Info, new RecordItemIndex(3));
